...
const styles = StyleSheet.create({
  ...
  categoryTag: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, marginBottom: 4 },
  categoryText: { fontSize: 10, fontWeight: '700' },
  messageText: { fontSize: 15, lineHeight: 21, fontWeight: '500' },
  time: { fontSize: 10, marginTop: 2, alignSelf: 'flex-end', fontWeight: '500' },
