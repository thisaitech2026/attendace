...
export function BottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end animate-fade-in">
      ...
      <div className="relative z-10 flex max-h-[92dvh] flex-col rounded-t-[28px] border border-border border-b-0 bg-surface-elevated safe-bottom shadow-2xl animate-slide-up">
